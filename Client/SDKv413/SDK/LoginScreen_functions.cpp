...
// Parameters:
// const class FText&                      EULA_Text                                              (Parm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// ELoginResult                            Login_Result                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const class FText&                      MESSAGE                                                (Parm)

void ULoginScreen_C::On_Login(ELoginResult Login_Result, const class FText& MESSAGE)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "On Login");

	Params::LoginScreen_C_On_Login Parms{};

	Parms.Login_Result = Login_Result;
	Parms.MESSAGE = std::move(MESSAGE);
