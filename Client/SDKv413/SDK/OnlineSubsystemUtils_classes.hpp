...
public:
	...
	uint8                                         Pad_3C1[0x57];                                     // 0x03C1(0x0057)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AOnlineBeaconClient) == 0x000418, "Wrong size on AOnlineBeaconClient");
...
static_assert(sizeof(ATestBeaconClient) == 0x000420, "Wrong size on ATestBeaconClient");
...
public:
	...
	class FString                                 DestSessionId;                                     // 0x04E0(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FPartyReservation                      PendingReservation;                                // 0x04F0(0x0030)(Protected, NativeAccessSpecifierProtected)
	EClientRequestType                            RequestType;                                       // 0x0520(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APartyBeaconClient) == 0x000550, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x0004E0, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x0004F0, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x000520, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x000521, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x000522, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
{
public:
	uint8                                         Pad_33648[0x20];                                   // 0x33648(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x033668, "Wrong size on UIpConnection");
...
static_assert(sizeof(UIpNetDriver) == 0x000430, "Wrong size on UIpNetDriver");
