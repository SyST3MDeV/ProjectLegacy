...
public:
	...
	bool                                          CallFunc_IsLoadingScreenVisible_ReturnValue;       // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EUpdateState                                  K2Node_Event_NewState;                             // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Event_NumDownloaded;                        // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_TotalFiles;                           // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_NumBytes;                             // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_TotalBytes;                           // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UOrionUIManagerWidget*                  CallFunc_GetUIManagerWidget_ReturnValue;           // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMenuContext*                           CallFunc_GetContext_ReturnValue;                   // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EOrionUIState                                 CallFunc_GetCurrentUIState_ReturnValue;            // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root) == 0x000070, "Wrong size on InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root");
...
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_IsLoadingScreenVisible_ReturnValue) == 0x000004, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_IsLoadingScreenVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, K2Node_Event_NewState) == 0x000005, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::K2Node_Event_NewState' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, K2Node_Event_NumDownloaded) == 0x000008, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::K2Node_Event_NumDownloaded' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, K2Node_Event_TotalFiles) == 0x00000C, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::K2Node_Event_TotalFiles' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, K2Node_Event_NumBytes) == 0x000010, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::K2Node_Event_NumBytes' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, K2Node_Event_TotalBytes) == 0x000014, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::K2Node_Event_TotalBytes' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000018, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_Greater_IntInt_ReturnValue) == 0x00001C, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_Conv_IntToFloat_ReturnValue2) == 0x000020, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_Conv_IntToFloat_ReturnValue2' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000024, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_GetContext_ReturnValue) == 0x000058, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_GetCurrentUIState_ReturnValue) == 0x000060, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_GetCurrentUIState_ReturnValue' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000061, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root, CallFunc_GetOwningPlayer_ReturnValue) == 0x000068, "Member 'InitialPreload_Root_C_ExecuteUbergraph_InitialPreload_Root::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
...
{
public:
	int32                                         NumDownloaded;                                     // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         TotalFiles;                                        // 0x0004(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         NumBytes;                                          // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         TotalBytes;                                        // 0x000C(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	EUpdateState                                  NewState;                                          // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	EReturnToMainMenuReason                       Reason;                                            // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
