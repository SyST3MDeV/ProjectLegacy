...
static_assert(sizeof(FClothVertBoneData) == 0x000030, "Wrong size on FClothVertBoneData");
...
static_assert(sizeof(FClothParameterMask_PhysMesh) == 0x000028, "Wrong size on FClothParameterMask_PhysMesh");
