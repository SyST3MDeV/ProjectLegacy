...
static_assert(sizeof(FMovieScene2DTransformSectionTemplate) == 0x000350, "Wrong size on FMovieScene2DTransformSectionTemplate");
...
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Translation) == 0x000040, "Member 'FMovieScene2DTransformSectionTemplate::Translation' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Rotation) == 0x000120, "Member 'FMovieScene2DTransformSectionTemplate::Rotation' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Scale) == 0x000190, "Member 'FMovieScene2DTransformSectionTemplate::Scale' has a wrong offset!");
static_assert(offsetof(FMovieScene2DTransformSectionTemplate, Shear) == 0x000270, "Member 'FMovieScene2DTransformSectionTemplate::Shear' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneMarginSectionTemplate) == 0x000200, "Wrong size on FMovieSceneMarginSectionTemplate");
...
static_assert(offsetof(FMovieSceneMarginSectionTemplate, LeftCurve) == 0x0000B0, "Member 'FMovieSceneMarginSectionTemplate::LeftCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, RightCurve) == 0x000120, "Member 'FMovieSceneMarginSectionTemplate::RightCurve' has a wrong offset!");
static_assert(offsetof(FMovieSceneMarginSectionTemplate, BottomCurve) == 0x000190, "Member 'FMovieSceneMarginSectionTemplate::BottomCurve' has a wrong offset!");
