...
static_assert(sizeof(AGC_States_Debuff_Silence_C) == 0x000780, "Wrong size on AGC_States_Debuff_Silence_C");
static_assert(offsetof(AGC_States_Debuff_Silence_C, UberGraphFrame) == 0x000770, "Member 'AGC_States_Debuff_Silence_C::UberGraphFrame' has a wrong offset!");
