...
public:
	...
	struct FCurveTableRowHandle                   Curve;                                             // 0x0008(0x0010)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayAbilitySpecDef) == 0x000050, "Wrong size on FGameplayAbilitySpecDef");
...
public:
	...
	uint8                                         Pad_2D5[0x17B];                                    // 0x02D5(0x017B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FActiveGameplayEffect) == 0x000010, "Wrong alignment on FActiveGameplayEffect");
static_assert(sizeof(FActiveGameplayEffect) == 0x000450, "Wrong size on FActiveGameplayEffect");
...
static_assert(sizeof(FGameplayAbilitySpec) == 0x000078, "Wrong size on FGameplayAbilitySpec");
...
public:
	...
	bool                                          bHasWorldOrigin;                                   // 0x006C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(FGameplayEffectContext, bHasWorldOrigin) == 0x00006C, "Member 'FGameplayEffectContext::bHasWorldOrigin' has a wrong offset!");
...
static_assert(sizeof(FGameplayCueNotifyData) == 0x000028, "Wrong size on FGameplayCueNotifyData");
...
static_assert(sizeof(FCustomCalculationBasedFloat) == 0x000080, "Wrong size on FCustomCalculationBasedFloat");
...
public:
	...
	struct FSetByCallerFloat                      SetByCallerMagnitude;                              // 0x01A8(0x0010)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FGameplayEffectModifierMagnitude) == 0x000008, "Wrong alignment on FGameplayEffectModifierMagnitude");
static_assert(sizeof(FGameplayEffectModifierMagnitude) == 0x0001B8, "Wrong size on FGameplayEffectModifierMagnitude");
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0050(0x01B8)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
public:
	...
	struct FGameplayEffectModifierMagnitude       ModifierMagnitude;                                 // 0x0030(0x01B8)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayModEvaluationChannelSettings  EvaluationChannelSettings;                         // 0x01E8(0x0001)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E9[0x7];                                      // 0x01E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagRequirements               SourceTags;                                        // 0x01F0(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0230(0x0040)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FGameplayEffectExecutionScopedModifierInfo) == 0x000270, "Wrong size on FGameplayEffectExecutionScopedModifierInfo");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, EvaluationChannelSettings) == 0x0001E8, "Member 'FGameplayEffectExecutionScopedModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, SourceTags) == 0x0001F0, "Member 'FGameplayEffectExecutionScopedModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x000230, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
