...
public:
	...
	int32                                         AudioTrackIndex;                                   // 0x0280(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_284[0x4];                                      // 0x0284(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UMediaPlayer*                           MediaPlayer;                                       // 0x0288(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UMediaSoundWave, AudioTrackIndex) == 0x000280, "Member 'UMediaSoundWave::AudioTrackIndex' has a wrong offset!");
static_assert(offsetof(UMediaSoundWave, MediaPlayer) == 0x000288, "Member 'UMediaSoundWave::MediaPlayer' has a wrong offset!");
