...
public:
	...
	uint8                                         Pad_9D[0x3F3];                                     // 0x009D(0x03F3)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UParty) == 0x000490, "Wrong size on UParty");
...
public:
	...
	uint8                                         Pad_2A8[0x2C0];                                    // 0x02A8(0x02C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPartyGameState) == 0x000568, "Wrong size on UPartyGameState");
