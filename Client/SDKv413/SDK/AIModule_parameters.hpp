...
static_assert(sizeof(AITask_MoveTo_AIMoveTo) == 0x000030, "Wrong size on AITask_MoveTo_AIMoveTo");
...
static_assert(offsetof(AITask_MoveTo_AIMoveTo, ReturnValue) == 0x000028, "Member 'AITask_MoveTo_AIMoveTo::ReturnValue' has a wrong offset!");
