...
namespace CG
{
	 ...
	 * Parameters:
	 * 		unsigned char                                      PreviousState                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UDraftLobbyRoot_C::OnEnterState(unsigned char PreviousState)
	{
	 ...
	 * 		Flags  -> (BlueprintEvent)
	 */
	void UDraftLobbyRoot_C::BndEvt__Button_LockInHero_K2Node_ComponentBoundEvent_13_OrionBaseButtonClicked__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> (Event, Protected, BlueprintEvent)
	 */
	void UDraftLobbyRoot_C::OnHeroLockedIn()
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> (Event, Protected, BlueprintEvent)
	 * Parameters:
	 * 		unsigned char                                      FirstPickerType                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UDraftLobbyRoot_C::OnDraftStarted(unsigned char FirstPickerType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> (Event, Protected, BlueprintEvent)
	 * Parameters:
	 * 		unsigned char                                      FinishedMemberType                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UDraftLobbyRoot_C::OnTurnComplete(unsigned char FinishedMemberType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> (Event, Protected, BlueprintEvent)
	 * Parameters:
	 * 		unsigned char                                      PickingMemberType                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UDraftLobbyRoot_C::OnTurnStarted(unsigned char PickingMemberType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> (BlueprintEvent)
	 * Parameters:
	 * 		class FActiveWidgetIndex*                          ActiveWidget                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 * 		int32_t                                            ActiveWidgetIndex                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UDraftLobbyRoot_C::BndEvt__OrionSwitcher_CenterContent_K2Node_ComponentBoundEvent_63_OnActiveWidgetChanged__DelegateSignature(class FActiveWidgetIndex* ActiveWidget, int32_t ActiveWidgetIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
