...
#include "GC_Item_Projectile_HitCharacter_PlayOnCharacter_CreepingDeath_classes.hpp"
#include "GC_Item_Projectile_HitCharacter_PlayOnCharacter_CreepingDeath_parameters.hpp"
...
void UGC_Item_Projectile_HitCharacter_PlayOnCharacter_CreepingDeath_C::OnBurst(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* BurstParticleSystem, TArray<class UParticleSystemComponent*>& AdditionalParticleSystems, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance, class UNiagaraComponent* BurstNiagaraParticleSystem, TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Projectile_HitCharacter_PlayOnCharacter_CreepingDeath_C", "OnBurst");

	Params::GC_Item_Projectile_HitCharacter_PlayOnCharacter_CreepingDeath_C_OnBurst Parms{};
