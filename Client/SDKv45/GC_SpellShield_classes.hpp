...
public:
	...
	float                                         ScaleFactor;                                       // 0x0848(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AGC_SpellShield_C) == 0x000850, "Wrong size on AGC_SpellShield_C");
static_assert(offsetof(AGC_SpellShield_C, UberGraphFrame) == 0x000840, "Member 'AGC_SpellShield_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGC_SpellShield_C, ScaleFactor) == 0x000848, "Member 'AGC_SpellShield_C::ScaleFactor' has a wrong offset!");
