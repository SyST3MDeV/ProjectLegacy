...
#include "GC_Juggernaut_classes.hpp"
#include "GC_Juggernaut_parameters.hpp"
...
void AGC_Juggernaut_C::ExecuteUbergraph_GC_Juggernaut(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Juggernaut_C", "ExecuteUbergraph_GC_Juggernaut");

	Params::GC_Juggernaut_C_ExecuteUbergraph_GC_Juggernaut Parms{};
...
// Function GC_Juggernaut.GC_Juggernaut_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Juggernaut_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Juggernaut_C", "UserConstructionScript");
