...
// Function GC_Death.GC_Death_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)

void AGC_Death_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Death_C", "ReceiveBeginPlay");
