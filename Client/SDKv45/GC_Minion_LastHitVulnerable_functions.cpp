...
#include "GC_Minion_LastHitVulnerable_classes.hpp"
#include "GC_Minion_LastHitVulnerable_parameters.hpp"
...
void AGC_Minion_LastHitVulnerable_C::ExecuteUbergraph_GC_Minion_LastHitVulnerable(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Minion_LastHitVulnerable_C", "ExecuteUbergraph_GC_Minion_LastHitVulnerable");

	Params::GC_Minion_LastHitVulnerable_C_ExecuteUbergraph_GC_Minion_LastHitVulnerable Parms{};
...
void AGC_Minion_LastHitVulnerable_C::K2_OnRemove(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* RemovalParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystems, class UNiagaraComponent* RemovalNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_Minion_LastHitVulnerable_C", "K2_OnRemove");

	Params::GC_Minion_LastHitVulnerable_C_K2_OnRemove Parms{};
...
void AGC_Minion_LastHitVulnerable_C::K2_WhileActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* LoopingParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystem, class UNiagaraComponent* LoopingNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_Minion_LastHitVulnerable_C", "K2_WhileActive");

	Params::GC_Minion_LastHitVulnerable_C_K2_WhileActive Parms{};
...
// Function GC_Minion_LastHitVulnerable.GC_Minion_LastHitVulnerable_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Minion_LastHitVulnerable_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Minion_LastHitVulnerable_C", "UserConstructionScript");
