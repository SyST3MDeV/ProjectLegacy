...
public:
	...
	uint8                                         Pad_198[0x288];                                    // 0x0198(0x0288)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ServerAbilityRPCBatch(const struct GameplayAbilitiesSDK::FServerAbilityRPCBatch& BatchInfo);
