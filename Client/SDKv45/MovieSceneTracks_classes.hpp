...
public:
	...
	uint8                                         bFollow : 1;                                       // 0x0194(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bReverse : 1;                                      // 0x0194(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bForceUpright : 1;                                 // 0x0194(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UMovieScene3DPathSection) == 0x0001A0, "Wrong size on UMovieScene3DPathSection");
...
static_assert(offsetof(UMovieScene3DPathSection, FrontAxisEnum) == 0x000190, "Member 'UMovieScene3DPathSection::FrontAxisEnum' has a wrong offset!");
static_assert(offsetof(UMovieScene3DPathSection, UpAxisEnum) == 0x000191, "Member 'UMovieScene3DPathSection::UpAxisEnum' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraCutSection) == 0x000120, "Wrong size on UMovieSceneCameraCutSection");
