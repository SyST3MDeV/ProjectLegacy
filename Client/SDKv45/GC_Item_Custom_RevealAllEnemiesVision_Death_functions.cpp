...
#include "GC_Item_Custom_RevealAllEnemiesVision_Death_classes.hpp"
#include "GC_Item_Custom_RevealAllEnemiesVision_Death_parameters.hpp"
...
void AGC_Item_Custom_RevealAllEnemiesVision_Death_C::ExecuteUbergraph_GC_Item_Custom_RevealAllEnemiesVision_Death(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Custom_RevealAllEnemiesVision_Death_C", "ExecuteUbergraph_GC_Item_Custom_RevealAllEnemiesVision_Death");

	Params::GC_Item_Custom_RevealAllEnemiesVision_Death_C_ExecuteUbergraph_GC_Item_Custom_RevealAllEnemiesVision_Death Parms{};
...
void AGC_Item_Custom_RevealAllEnemiesVision_Death_C::K2_OnActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* ApplicationParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystems, class UCameraShake* ApplicationCameraShakeInstance, class UNiagaraComponent* ApplicationNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Custom_RevealAllEnemiesVision_Death_C", "K2_OnActive");

	Params::GC_Item_Custom_RevealAllEnemiesVision_Death_C_K2_OnActive Parms{};
...
// Function GC_Item_Custom_RevealAllEnemiesVision_Death.GC_Item_Custom_RevealAllEnemiesVision_Death_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Item_Custom_RevealAllEnemiesVision_Death_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Custom_RevealAllEnemiesVision_Death_C", "UserConstructionScript");
