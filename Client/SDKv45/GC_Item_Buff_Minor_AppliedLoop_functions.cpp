...
#include "GC_Item_Buff_Minor_AppliedLoop_parameters.hpp"
...
void AGC_Item_Buff_Minor_AppliedLoop_C::ExecuteUbergraph_GC_Item_Buff_Minor_AppliedLoop(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Buff_Minor_AppliedLoop_C", "ExecuteUbergraph_GC_Item_Buff_Minor_AppliedLoop");

	Params::GC_Item_Buff_Minor_AppliedLoop_C_ExecuteUbergraph_GC_Item_Buff_Minor_AppliedLoop Parms{};
...
void AGC_Item_Buff_Minor_AppliedLoop_C::K2_OnActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* ApplicationParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystems, class UCameraShake* ApplicationCameraShakeInstance, class UNiagaraComponent* ApplicationNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Buff_Minor_AppliedLoop_C", "K2_OnActive");

	Params::GC_Item_Buff_Minor_AppliedLoop_C_K2_OnActive Parms{};
...
// Function GC_Item_Buff_Minor_AppliedLoop.GC_Item_Buff_Minor_AppliedLoop_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Item_Buff_Minor_AppliedLoop_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Buff_Minor_AppliedLoop_C", "UserConstructionScript");
