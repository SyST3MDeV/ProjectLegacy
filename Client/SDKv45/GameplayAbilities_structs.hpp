...
struct GameplayAbilitiesSDK::FServerAbilityRPCBatch final
{
public:
...
static_assert(alignof(GameplayAbilitiesSDK::FServerAbilityRPCBatch) == 0x000008, "Wrong alignment on GameplayAbilitiesSDK::FServerAbilityRPCBatch");
static_assert(sizeof(GameplayAbilitiesSDK::FServerAbilityRPCBatch) == 0x000048, "Wrong size on GameplayAbilitiesSDK::FServerAbilityRPCBatch");
static_assert(offsetof(GameplayAbilitiesSDK::FServerAbilityRPCBatch, AbilitySpecHandle) == 0x000000, "Member 'GameplayAbilitiesSDK::FServerAbilityRPCBatch::AbilitySpecHandle' has a wrong offset!");
static_assert(offsetof(GameplayAbilitiesSDK::FServerAbilityRPCBatch, PredictionKey) == 0x000008, "Member 'GameplayAbilitiesSDK::FServerAbilityRPCBatch::PredictionKey' has a wrong offset!");
static_assert(offsetof(GameplayAbilitiesSDK::FServerAbilityRPCBatch, TargetData) == 0x000020, "Member 'GameplayAbilitiesSDK::FServerAbilityRPCBatch::TargetData' has a wrong offset!");
static_assert(offsetof(GameplayAbilitiesSDK::FServerAbilityRPCBatch, InputPressed) == 0x000040, "Member 'GameplayAbilitiesSDK::FServerAbilityRPCBatch::InputPressed' has a wrong offset!");
static_assert(offsetof(GameplayAbilitiesSDK::FServerAbilityRPCBatch, Ended) == 0x000041, "Member 'GameplayAbilitiesSDK::FServerAbilityRPCBatch::Ended' has a wrong offset!");
static_assert(offsetof(GameplayAbilitiesSDK::FServerAbilityRPCBatch, Started) == 0x000042, "Member 'GameplayAbilitiesSDK::FServerAbilityRPCBatch::Started' has a wrong offset!");
