...
//Thanks Fischsalat!
//https://github.com/Fischsalat/UnrealContainers
...
#pragma warning(suppress: 4244)
	...
	*/
	...
	template<typename T> inline Iterators::TArrayIterator<T> end(const TArray<T>& Array) { return Iterators::TArrayIterator<T>(Array, Array.NumElements); }
