...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_TOJK[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_W1EI[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_P21D[0x10];                                  // 0x0088(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DVZZ[0x130];                                 // 0x0028(0x0130) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HLOA[0x198];                                 // 0x0088(0x0198) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_QE8G4XN68D[0x01];                                    // 0x008F(0x0001) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_X5E7TYRRQG[0x04];                                    // 0x00AC(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_FV7M[0x68];                                  // 0x0220(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GL8A[0xB8];                                  // 0x0028(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7Q5P[0x28];                                  // 0x0030(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HBQ8[0x150];                                 // 0x0220(0x0150) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_TC5W[0x60];                                  // 0x0028(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MZ2L[0x150];                                 // 0x00B8(0x0150) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3XR7[0xA0];                                  // 0x0028(0x00A0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RD79[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9A24[0x48];                                  // 0x0030(0x0048) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I2F3[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_78MV[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VG7Z[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UL6G[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HV1N[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_F6QK[0x8];                                   // 0x0080(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_M3KP[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_J617[0x38];                                  // 0x0078(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_U13J[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RRGQ[0x28];                                  // 0x0078(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Q9Z1[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
