...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GC_Shared_SpeedBuff.GC_Shared_SpeedBuff_C.UserConstructionScript
	 */
	struct AGC_Shared_SpeedBuff_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Shared_SpeedBuff.GC_Shared_SpeedBuff_C.K2_WhileActive
	 */
	struct AGC_Shared_SpeedBuff_C_K2_WhileActive_Params
	{
	public:
	 ...
	 */
	struct AGC_Shared_SpeedBuff_C_K2_OnRemove_Params
	{
	public:
		class AActor*                                              MyTarget;                                                // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		struct FGameplayCueParameters                              Parameters;                                              // 0x0008(0x00B8)  (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	 ...
	 */
	struct AGC_Shared_SpeedBuff_C_ExecuteUbergraph_GC_Shared_SpeedBuff_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_DQZ9[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
