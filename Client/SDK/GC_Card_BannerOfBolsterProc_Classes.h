...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_Card_BannerOfBolsterProc.GC_Card_BannerOfBolsterProc_C
	 * Size -> 0x0008 (FullSize[0x0590] - InheritedSize[0x0588])
	 */
	class AGC_Card_BannerOfBolsterProc_C : public AOrionGameplayCueNotify_Burst_Latent
	{
	public:
