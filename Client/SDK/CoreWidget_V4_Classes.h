...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass CoreWidget_V4.CoreWidget-V4_C
	 * Size -> 0x0048 (FullSize[0x03D0] - InheritedSize[0x0388])
	 */
	class UCoreWidgetV4_C : public UOrionCoreWidget
	{
	public:
	...
	public:
		...
		void OnCoreExposed();
		void OnCoreDamaged();
		void ExecuteUbergraph_CoreWidgetV4(int32_t EntryPoint);
