...
namespace CG
{
	 ...
	 */
	struct AGC_Rigs_Collecting_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Rigs_Collecting.GC_Rigs_Collecting_C.K2_WhileActive
	 */
	struct AGC_Rigs_Collecting_C_K2_WhileActive_Params
	{
	public:
	 ...
	 */
	struct AGC_Rigs_Collecting_C_K2_OnRemove_Params
	{
	public:
		class AActor*                                              MyTarget;                                                // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		struct FGameplayCueParameters                              Parameters;                                              // 0x0008(0x00B8)  (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	 ...
	 */
	struct AGC_Rigs_Collecting_C_ExecuteUbergraph_GC_Rigs_Collecting_Params
	{
	public:
