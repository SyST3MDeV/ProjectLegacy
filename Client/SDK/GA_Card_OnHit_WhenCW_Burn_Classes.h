...
namespace CG
{
	...
	public:
		void OnApplied_F496FCFC47E7B1F67E5588BB80A651FD(class AActor* Target, const struct FGameplayEffectSpecHandle& SpecHandle, const struct FActiveGameplayEffectHandle& ActiveHandle);
