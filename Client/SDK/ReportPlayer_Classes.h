...
namespace CG
{
	 ...
	 */
	class UReportPlayer_C : public UOrionActivatableWidget
	{
	public:
		unsigned char                                              UnknownData_3K7C[0x8];                                   // 0x0438(0x0008) Fix Super Size
		...
		class UDefaultButton_C*                                    DefaultButtonSubmit;                                     // 0x0458(0x0008) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor
		class UOrionTextBlock*                                     OrionTextFeedback;                                       // 0x0460(0x0008) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor
		class UWidget*                                             HudMenu;                                                 // 0x0468(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_ReportPlayer(int32_t EntryPoint);
