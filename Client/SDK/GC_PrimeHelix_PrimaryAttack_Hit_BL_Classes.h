...
namespace CG
{
	 ...
	 */
	class AGC_PrimeHelix_PrimaryAttack_Hit_BL_C : public AOrionGameplayCueNotify_Burst_Latent
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GC_PrimeHelix_PrimaryAttack_Hit_BL(int32_t EntryPoint);
