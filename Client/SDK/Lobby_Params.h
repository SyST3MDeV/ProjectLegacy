...
namespace CG
{
	...
	{
	public:
		struct FUniqueNetIdRepl                                    InUniqueId;                                              // 0x0000(0x0018)  (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
		struct FUniqueNetIdRepl                                    InPartyOwnerId;                                          // 0x0018(0x0018)  (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		struct FUniqueNetIdRepl                                    InUniqueId;                                              // 0x0010(0x0018)  (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
	...
	{
	public:
		struct FUniqueNetIdRepl                                    PlayerToKick;                                            // 0x0000(0x0018)  (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
	...
	{
	public:
		struct FJoinabilitySettings                                Settings;                                                // 0x0000(0x0018)  (ConstParm, Parm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		struct FUniqueNetIdRepl                                    InUniqueId;                                              // 0x0018(0x0018)  (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
	};
	...
	public:
		struct FUniqueNetIdRepl                                    InUniqueId;                                              // 0x0000(0x0018)  (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
		bool                                                       bWasSuccessful;                                          // 0x0018(0x0001)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	};
