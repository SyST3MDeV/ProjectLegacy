...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_Hero_Dialog_Status_Respawn.GC_Hero_Dialog_Status_Respawn_C
	 * Size -> 0x0008 (FullSize[0x0590] - InheritedSize[0x0588])
	 */
	class AGC_Hero_Dialog_Status_Respawn_C : public AOrionGameplayCueNotify_Burst_Latent
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GC_Hero_Dialog_Status_Respawn(int32_t EntryPoint);
