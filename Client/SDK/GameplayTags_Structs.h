...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XOKM[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_31NX[0x78];                                  // 0x0000(0x0078) MISSED OFFSET (PADDING)
	};
