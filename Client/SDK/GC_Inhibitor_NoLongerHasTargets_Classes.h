...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_Inhibitor_NoLongerHasTargets.GC_Inhibitor_NoLongerHasTargets_C
	 * Size -> 0x0010 (FullSize[0x0720] - InheritedSize[0x0710])
	 */
	class AGC_Inhibitor_NoLongerHasTargets_C : public AOrionGameplayCueNotify_Looping
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GC_Inhibitor_NoLongerHasTargets(int32_t EntryPoint);
