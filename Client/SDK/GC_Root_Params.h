...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GC_Root.GC_Root_C.UserConstructionScript
	 */
	struct AGC_Root_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Root.GC_Root_C.K2_WhileActive
	 */
	struct AGC_Root_C_K2_WhileActive_Params
	{
	public:
	...
	/**
	 * Function GC_Root.GC_Root_C.ExecuteUbergraph_GC_Root
	 */
	struct AGC_Root_C_ExecuteUbergraph_GC_Root_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_62ER[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
