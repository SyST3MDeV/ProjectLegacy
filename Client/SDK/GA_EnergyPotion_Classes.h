...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * GameplayAbilityBlueprintGeneratedClass GA_EnergyPotion.GA_EnergyPotion_C
	 * Size -> 0x0050 (FullSize[0x0AA0] - InheritedSize[0x0A50])
	 */
	class UGA_EnergyPotion_C : public UOrionAbility
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GA_EnergyPotion(int32_t EntryPoint);
