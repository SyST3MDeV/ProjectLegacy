...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_Tower_NoLongerHasTargets.GC_Tower_NoLongerHasTargets_C
	 * Size -> 0x0010 (FullSize[0x0720] - InheritedSize[0x0710])
	 */
	class AGC_Tower_NoLongerHasTargets_C : public AOrionGameplayCueNotify_Looping
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GC_Tower_NoLongerHasTargets(int32_t EntryPoint);
