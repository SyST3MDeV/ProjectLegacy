...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AACC[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_O8JP[0x1];                                   // 0x0033(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NOWS[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (PADDING)
	};
