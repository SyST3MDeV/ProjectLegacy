...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_84BE[0x1];                                   // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8WXV[0x1];                                   // 0x0011(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AWRX[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_2G6J[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_ANUL[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                Text;                                                    // 0x0038(0x0018) NativeAccessSpecifierPublic
		struct FVector                                             Vector;                                                  // 0x0050(0x000C) ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_GO1H[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_2AHK[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		TMap<class FString, struct FVector>                        StrToVec;                                                // 0x0050(0x0050) ZeroConstructor, NativeAccessSpecifierPublic
	};
	...
	{
	public:
		struct FStructSerializerNumericTestStruct                  Numerics;                                                // 0x0000(0x0030) NativeAccessSpecifierPublic
		struct FStructSerializerBooleanTestStruct                  Booleans;                                                // 0x0030(0x0008) NativeAccessSpecifierPublic
		struct FStructSerializerObjectTestStruct                   Objects;                                                 // 0x0038(0x0010) NativeAccessSpecifierPublic
		...
		struct FStructSerializerMapTestStruct                      Maps;                                                    // 0x00E8(0x00A0) NativeAccessSpecifierPublic
	};
