...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass AbilityWidget_V4.AbilityWidget-V4_C
	 * Size -> 0x0058 (FullSize[0x0548] - InheritedSize[0x04F0])
	 */
	class UAbilityWidgetV4_C : public UOrionAbilityWidget
	{
	public:
		...
		class UInvalidationBox*                                    InvalidationBox_3;                                       // 0x0530(0x0008) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor
	...
	public:
		...
		void ShowStacks();
		void HideStacks();
		void ExecuteUbergraph_AbilityWidgetV4(int32_t EntryPoint);
