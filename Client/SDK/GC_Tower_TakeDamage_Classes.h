...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_Tower_TakeDamage.GC_Tower_TakeDamage_C
	 * Size -> 0x0018 (FullSize[0x04D8] - InheritedSize[0x04C0])
	 */
	class UGC_Tower_TakeDamage_C : public UOrionGameplayCueNotify_Burst
	{
	public:
		class FName                                                FX_Center;                                               // 0x04C0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
