...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_AI_Spawner_Jungle_Black.BP_AI_Spawner_Jungle_Black_C
	 * Size -> 0x0013 (FullSize[0x0698] - InheritedSize[0x0685])
	 */
	class ABP_AI_Spawner_Jungle_Black_C : public ABP_OrionCharAISpawner_Jungle_C
	{
	public:
		unsigned char                                              UnknownData_TNQ8[0x3];                                   // 0x0685(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
