...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_Card_PrimeCard_MHP.GC_Card_PrimeCard_MHP_C
	 * Size -> 0x0008 (FullSize[0x0718] - InheritedSize[0x0710])
	 */
	class AGC_Card_PrimeCard_MHP_C : public AOrionGameplayCueNotify_Looping
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GC_Card_PrimeCard_MHP(int32_t EntryPoint);
