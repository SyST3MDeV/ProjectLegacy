...
namespace CG
{
	 ...
	 */
	struct AGC_Wells_Geyser_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Wells_Geyser.GC_Wells_Geyser_C.K2_OnActive
	 */
	struct AGC_Wells_Geyser_C_K2_OnActive_Params
	{
	public:
	 ...
	 */
	struct AGC_Wells_Geyser_C_ExecuteUbergraph_GC_Wells_Geyser_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_436L[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
