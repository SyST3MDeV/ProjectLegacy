...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GC_Card_PortalStone_IncomingFX.GC_Card_PortalStone_IncomingFX_C.UserConstructionScript
	 */
	struct AGC_Card_PortalStone_IncomingFX_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Card_PortalStone_IncomingFX.GC_Card_PortalStone_IncomingFX_C.K2_OnActive
	 */
	struct AGC_Card_PortalStone_IncomingFX_C_K2_OnActive_Params
	{
	public:
	...
	/**
	 * Function GC_Card_PortalStone_IncomingFX.GC_Card_PortalStone_IncomingFX_C.K2_WhileActive
	 */
	struct AGC_Card_PortalStone_IncomingFX_C_K2_WhileActive_Params
	{
	public:
		class AActor*                                              MyTarget;                                                // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		struct FGameplayCueParameters                              Parameters;                                              // 0x0008(0x00B8)  (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	...
	/**
	 * Function GC_Card_PortalStone_IncomingFX.GC_Card_PortalStone_IncomingFX_C.ExecuteUbergraph_GC_Card_PortalStone_IncomingFX
	 */
	struct AGC_Card_PortalStone_IncomingFX_C_ExecuteUbergraph_GC_Card_PortalStone_IncomingFX_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_M4BR[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
