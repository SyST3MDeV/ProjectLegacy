...
namespace CG
{
	 ...
	 */
	struct AGC_Tower_Idle_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Tower_Idle.GC_Tower_Idle_C.K2_WhileActive
	 */
	struct AGC_Tower_Idle_C_K2_WhileActive_Params
	{
	public:
	...
	/**
	 * Function GC_Tower_Idle.GC_Tower_Idle_C.ExecuteUbergraph_GC_Tower_Idle
	 */
	struct AGC_Tower_Idle_C_ExecuteUbergraph_GC_Tower_Idle_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_RBCD[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
