...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OR3S[0x3];                                   // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_081Z[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RG2G[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
