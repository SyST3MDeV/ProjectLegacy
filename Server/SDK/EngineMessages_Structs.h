...
namespace CG
{
	...
	public:
		...
		bool                                                       HasBegunPlay;                                            // 0x0014(0x0001) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_TFW1[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FGuid                                               SessionId;                                               // 0x0038(0x0010) Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_QQT0[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_QD26[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
