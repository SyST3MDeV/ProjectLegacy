...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Prime_Primary_Decal.BP_Prime_Primary_Decal_C
	 * Size -> 0x0018 (FullSize[0x03A0] - InheritedSize[0x0388])
	 */
	class ABP_Prime_Primary_Decal_C : public ADecalActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Prime_Primary_Decal(int32_t EntryPoint);
