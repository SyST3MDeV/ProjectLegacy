...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GC_Prime_Helix_SpecialAttack3_SegFX.GC_Prime_Helix_SpecialAttack3_SegFX_C.OnBurst
	 */
	struct UGC_Prime_Helix_SpecialAttack3_SegFX_C_OnBurst_Params
	{
	public:
