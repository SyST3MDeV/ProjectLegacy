...
namespace CG
{
	 ...
	 */
	struct AGC_PrimeHelix_Carried_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_PrimeHelix_Carried.GC_PrimeHelix_Carried_C.K2_WhileActive
	 */
	struct AGC_PrimeHelix_Carried_C_K2_WhileActive_Params
	{
	public:
	 ...
	 */
	struct AGC_PrimeHelix_Carried_C_ExecuteUbergraph_GC_PrimeHelix_Carried_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_JHFW[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
