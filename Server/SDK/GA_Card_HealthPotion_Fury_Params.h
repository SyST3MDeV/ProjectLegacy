...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GA_Card_HealthPotion_Fury.GA_Card_HealthPotion_Fury_C.K2_CanActivateAbility
	 */
	struct UGA_Card_HealthPotion_Fury_C_K2_CanActivateAbility_Params
	{
	public:
		...
		unsigned char                                              UnknownData_0DBE[0x3];                                   // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
