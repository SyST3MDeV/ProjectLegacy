...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MJTZ[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		bool                                                       bIsConsumable;                                           // 0x0010(0x0001) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_0UER[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
