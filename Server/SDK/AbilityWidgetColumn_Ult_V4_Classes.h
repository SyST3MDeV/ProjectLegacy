...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass AbilityWidgetColumn_Ult_V4.AbilityWidgetColumn-Ult-V4_C
	 * Size -> 0x0028 (FullSize[0x0340] - InheritedSize[0x0318])
	 */
	class UAbilityWidgetColumnUltV4_C : public UOrionAbilityWidgetColumn
	{
	public:
		...
		class UImage*                                              UpgradePulseImage;                                       // 0x0338(0x0008) BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor

	public:
		void ShowLevelUp();
		void HideLevelUp();
		void OnAnimationFinished(class UWidgetAnimation* Animation);
		void ExecuteUbergraph_AbilityWidgetColumnUltV4(int32_t EntryPoint);
