...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_Aura_Armor.GC_Aura_Armor_C
	 * Size -> 0x0008 (FullSize[0x0718] - InheritedSize[0x0710])
	 */
	class AGC_Aura_Armor_C : public AOrionGameplayCueNotify_Looping
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GC_Aura_Armor(int32_t EntryPoint);
