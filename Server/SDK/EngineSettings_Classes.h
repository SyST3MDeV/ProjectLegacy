...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3GUK[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4QGN[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_58MC[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_AGKI[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_YG9P[0x3];                                   // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NTPQ[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K3YA[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool                                                       bUseBorderlessWindow;                                    // 0x0109(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		bool                                                       bStartInVR;                                              // 0x010A(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		bool                                                       bAllowWindowResize;                                      // 0x010B(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		bool                                                       bAllowClose;                                             // 0x010C(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		bool                                                       bAllowMaximize;                                          // 0x010D(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		bool                                                       bAllowMinimize;                                          // 0x010E(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_9B47[0x1];                                   // 0x010F(0x0001) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_15GB[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
