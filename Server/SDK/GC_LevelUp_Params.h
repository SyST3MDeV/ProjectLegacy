...
namespace CG
{
	 ...
	 */
	struct AGC_LevelUp_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_LevelUp.GC_LevelUp_C.Timeline_0__FinishedFunc
	 */
	struct AGC_LevelUp_C_Timeline_0__FinishedFunc_Params
	{	};

	/**
	 * Function GC_LevelUp.GC_LevelUp_C.Timeline_0__UpdateFunc
	 */
	struct AGC_LevelUp_C_Timeline_0__UpdateFunc_Params
	{	};

	/**
	 * Function GC_LevelUp.GC_LevelUp_C.K2_OnExecute
	 */
	struct AGC_LevelUp_C_K2_OnExecute_Params
	{
	public:
	 ...
	 */
	struct AGC_LevelUp_C_ExecuteUbergraph_GC_LevelUp_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_00Y1[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
