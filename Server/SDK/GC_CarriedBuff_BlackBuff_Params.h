...
namespace CG
{
	 ...
	 */
	struct AGC_CarriedBuff_BlackBuff_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_CarriedBuff_BlackBuff.GC_CarriedBuff_BlackBuff_C.K2_OnActive
	 */
	struct AGC_CarriedBuff_BlackBuff_C_K2_OnActive_Params
	{
	public:
	 ...
	 */
	struct AGC_CarriedBuff_BlackBuff_C_K2_WhileActive_Params
	{
	public:
		class AActor*                                              MyTarget;                                                // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		struct FGameplayCueParameters                              Parameters;                                              // 0x0008(0x00B8)  (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	 ...
	 */
	struct AGC_CarriedBuff_BlackBuff_C_ExecuteUbergraph_GC_CarriedBuff_BlackBuff_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_ES1S[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
