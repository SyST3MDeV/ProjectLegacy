...
namespace CG
{
	...
	public:
		void OnApplied_06FF9A3D4ECEBF76962748A1D923877B(class AActor* Target, const struct FGameplayEffectSpecHandle& SpecHandle, const struct FActiveGameplayEffectHandle& ActiveHandle);
