...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GC_Slow.GC_Slow_C.UserConstructionScript
	 */
	struct AGC_Slow_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Slow.GC_Slow_C.K2_WhileActive
	 */
	struct AGC_Slow_C_K2_WhileActive_Params
	{
	public:
	...
	/**
	 * Function GC_Slow.GC_Slow_C.ExecuteUbergraph_GC_Slow
	 */
	struct AGC_Slow_C_ExecuteUbergraph_GC_Slow_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_D02C[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
