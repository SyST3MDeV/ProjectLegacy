...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass AbilityFail_Cooldown.AbilityFail_Cooldown_C
	 * Size -> 0x0018 (FullSize[0x0378] - InheritedSize[0x0360])
	 */
	class UAbilityFail_Cooldown_C : public UOrionCombatMessageWidget
	{
	public:
	...
	public:
		void Construct();
		void ExecuteUbergraph_AbilityFail_Cooldown(int32_t EntryPoint);
