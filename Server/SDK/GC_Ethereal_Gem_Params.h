...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GC_Ethereal_Gem.GC_Ethereal_Gem_C.UserConstructionScript
	 */
	struct AGC_Ethereal_Gem_C_UserConstructionScript_Params
	{	};

	/**
	 * Function GC_Ethereal_Gem.GC_Ethereal_Gem_C.K2_OnActive
	 */
	struct AGC_Ethereal_Gem_C_K2_OnActive_Params
	{
	public:
	...
	/**
	 * Function GC_Ethereal_Gem.GC_Ethereal_Gem_C.K2_OnRemove
	 */
	struct AGC_Ethereal_Gem_C_K2_OnRemove_Params
	{
	public:
		class AActor*                                              MyTarget;                                                // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		struct FGameplayCueParameters                              Parameters;                                              // 0x0008(0x00B8)  (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	...
	/**
	 * Function GC_Ethereal_Gem.GC_Ethereal_Gem_C.ExecuteUbergraph_GC_Ethereal_Gem
	 */
	struct AGC_Ethereal_Gem_C_ExecuteUbergraph_GC_Ethereal_Gem_Params
	{
	public:
