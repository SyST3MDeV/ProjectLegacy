...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_Reticle3D_RigPlacementTargeting.BP_Reticle3D_RigPlacementTargeting_C
	 * Size -> 0x0018 (FullSize[0x03B8] - InheritedSize[0x03A0])
	 */
	class ABP_Reticle3D_RigPlacementTargeting_C : public AGameplayAbilityWorldReticle
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_Reticle3D_RigPlacementTargeting(int32_t EntryPoint);
