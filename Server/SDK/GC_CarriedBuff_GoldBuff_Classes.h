...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GC_CarriedBuff_GoldBuff.GC_CarriedBuff_GoldBuff_C
	 * Size -> 0x0020 (FullSize[0x0730] - InheritedSize[0x0710])
	 */
	class AGC_CarriedBuff_GoldBuff_C : public AOrionGameplayCueNotify_Looping
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_GC_CarriedBuff_GoldBuff(int32_t EntryPoint);
