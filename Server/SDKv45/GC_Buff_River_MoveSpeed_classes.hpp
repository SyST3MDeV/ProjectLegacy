...
static_assert(sizeof(AGC_Buff_River_MoveSpeed_C) == 0x000860, "Wrong size on AGC_Buff_River_MoveSpeed_C");
static_assert(offsetof(AGC_Buff_River_MoveSpeed_C, UberGraphFrame) == 0x000840, "Member 'AGC_Buff_River_MoveSpeed_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGC_Buff_River_MoveSpeed_C, HelixColorName) == 0x000848, "Member 'AGC_Buff_River_MoveSpeed_C::HelixColorName' has a wrong offset!");
static_assert(offsetof(AGC_Buff_River_MoveSpeed_C, ColorParam) == 0x000850, "Member 'AGC_Buff_River_MoveSpeed_C::ColorParam' has a wrong offset!");
