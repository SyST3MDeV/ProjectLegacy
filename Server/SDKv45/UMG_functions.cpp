...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInAllowMouseKeys                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UInputKeySelector::SetAllowMouseKeys(bool bInAllowMouseKeys)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InputKeySelector", "SetAllowMouseKeys");

	Params::InputKeySelector_SetAllowMouseKeys Parms{};

	Parms.bInAllowMouseKeys = bInAllowMouseKeys;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInRightClickToEmpty                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UInputKeySelector::SetRightClickToEmpty(bool bInRightClickToEmpty)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("InputKeySelector", "SetRightClickToEmpty");

	Params::InputKeySelector_SetRightClickToEmpty Parms{};

	Parms.bInRightClickToEmpty = bInRightClickToEmpty;
