...
#include "GC_Item_Debuff_Major_Burst_classes.hpp"
#include "GC_Item_Debuff_Major_Burst_parameters.hpp"
...
void AGC_Item_Debuff_Major_Burst_C::ExecuteUbergraph_GC_Item_Debuff_Major_Burst(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Debuff_Major_Burst_C", "ExecuteUbergraph_GC_Item_Debuff_Major_Burst");

	Params::GC_Item_Debuff_Major_Burst_C_ExecuteUbergraph_GC_Item_Debuff_Major_Burst Parms{};
...
void AGC_Item_Debuff_Major_Burst_C::K2_OnActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* ApplicationParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystems, class UCameraShake* ApplicationCameraShakeInstance, class UNiagaraComponent* ApplicationNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Debuff_Major_Burst_C", "K2_OnActive");

	Params::GC_Item_Debuff_Major_Burst_C_K2_OnActive Parms{};
...
// Function GC_Item_Debuff_Major_Burst.GC_Item_Debuff_Major_Burst_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Item_Debuff_Major_Burst_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Debuff_Major_Burst_C", "UserConstructionScript");
