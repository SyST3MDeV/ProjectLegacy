...
#include "GC_Recall_Teleport_classes.hpp"
#include "GC_Recall_Teleport_parameters.hpp"
...
void UGC_Recall_Teleport_C::ExecuteUbergraph_GC_Recall_Teleport(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Recall_Teleport_C", "ExecuteUbergraph_GC_Recall_Teleport");

	Params::GC_Recall_Teleport_C_ExecuteUbergraph_GC_Recall_Teleport Parms{};
...
void UGC_Recall_Teleport_C::HandleRotationalContent(const struct FGameplayTagContainer& TagsToHandle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Recall_Teleport_C", "HandleRotationalContent");

	Params::GC_Recall_Teleport_C_HandleRotationalContent Parms{};
