...
static_assert(sizeof(AGC_CarriedBuff_BlueBuff_C) == 0x000860, "Wrong size on AGC_CarriedBuff_BlueBuff_C");
static_assert(offsetof(AGC_CarriedBuff_BlueBuff_C, UberGraphFrame) == 0x000840, "Member 'AGC_CarriedBuff_BlueBuff_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGC_CarriedBuff_BlueBuff_C, HelixColorName) == 0x000848, "Member 'AGC_CarriedBuff_BlueBuff_C::HelixColorName' has a wrong offset!");
static_assert(offsetof(AGC_CarriedBuff_BlueBuff_C, ColorParam) == 0x000850, "Member 'AGC_CarriedBuff_BlueBuff_C::ColorParam' has a wrong offset!");
