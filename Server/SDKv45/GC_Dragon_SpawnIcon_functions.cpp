...
#include "GC_Dragon_SpawnIcon_classes.hpp"
#include "GC_Dragon_SpawnIcon_parameters.hpp"
...
void AGC_Dragon_SpawnIcon_C::ExecuteUbergraph_GC_Dragon_SpawnIcon(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Dragon_SpawnIcon_C", "ExecuteUbergraph_GC_Dragon_SpawnIcon");

	Params::GC_Dragon_SpawnIcon_C_ExecuteUbergraph_GC_Dragon_SpawnIcon Parms{};
...
void AGC_Dragon_SpawnIcon_C::K2_WhileActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* LoopingParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystem, class UNiagaraComponent* LoopingNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Dragon_SpawnIcon_C", "K2_WhileActive");

	Params::GC_Dragon_SpawnIcon_C_K2_WhileActive Parms{};
...
// Function GC_Dragon_SpawnIcon.GC_Dragon_SpawnIcon_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Dragon_SpawnIcon_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Dragon_SpawnIcon_C", "UserConstructionScript");
