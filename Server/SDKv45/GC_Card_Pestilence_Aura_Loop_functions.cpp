...
#include "GC_Card_Pestilence_Aura_Loop_classes.hpp"
#include "GC_Card_Pestilence_Aura_Loop_parameters.hpp"
...
void AGC_Card_Pestilence_Aura_Loop_C::ExecuteUbergraph_GC_Card_Pestilence_Aura_Loop(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Card_Pestilence_Aura_Loop_C", "ExecuteUbergraph_GC_Card_Pestilence_Aura_Loop");

	Params::GC_Card_Pestilence_Aura_Loop_C_ExecuteUbergraph_GC_Card_Pestilence_Aura_Loop Parms{};
...
void AGC_Card_Pestilence_Aura_Loop_C::K2_WhileActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* LoopingParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystem, class UNiagaraComponent* LoopingNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GC_Card_Pestilence_Aura_Loop_C", "K2_WhileActive");

	Params::GC_Card_Pestilence_Aura_Loop_C_K2_WhileActive Parms{};
...
// Function GC_Card_Pestilence_Aura_Loop.GC_Card_Pestilence_Aura_Loop_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Card_Pestilence_Aura_Loop_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Card_Pestilence_Aura_Loop_C", "UserConstructionScript");
