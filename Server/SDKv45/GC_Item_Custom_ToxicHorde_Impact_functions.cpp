...
#include "GC_Item_Custom_ToxicHorde_Impact_classes.hpp"
#include "GC_Item_Custom_ToxicHorde_Impact_parameters.hpp"
...
void AGC_Item_Custom_ToxicHorde_Impact_C::ExecuteUbergraph_GC_Item_Custom_ToxicHorde_Impact(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Custom_ToxicHorde_Impact_C", "ExecuteUbergraph_GC_Item_Custom_ToxicHorde_Impact");

	Params::GC_Item_Custom_ToxicHorde_Impact_C_ExecuteUbergraph_GC_Item_Custom_ToxicHorde_Impact Parms{};
...
// Function GC_Item_Custom_ToxicHorde_Impact.GC_Item_Custom_ToxicHorde_Impact_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Item_Custom_ToxicHorde_Impact_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Custom_ToxicHorde_Impact_C", "UserConstructionScript");
