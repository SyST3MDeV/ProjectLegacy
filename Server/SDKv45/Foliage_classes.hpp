...
{
public:
	UMulticastDelegateProperty_                   OnInstanceTakePointDamage;                         // 0x0900(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnInstanceTakeRadialDamage;                        // 0x0910(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UFoliageInstancedStaticMeshComponent) == 0x000920, "Wrong size on UFoliageInstancedStaticMeshComponent");
...
static_assert(sizeof(UInteractiveFoliageComponent) == 0x000730, "Wrong size on UInteractiveFoliageComponent");
