...
// Function UMG.InputKeySelector.SetAllowMouseKeys
// 0x0001 (0x0001 - 0x0000)
struct InputKeySelector_SetAllowMouseKeys final
{
public:
	bool                                          bInAllowMouseKeys;                                 // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(InputKeySelector_SetAllowMouseKeys) == 0x000001, "Wrong alignment on InputKeySelector_SetAllowMouseKeys");
static_assert(sizeof(InputKeySelector_SetAllowMouseKeys) == 0x000001, "Wrong size on InputKeySelector_SetAllowMouseKeys");
static_assert(offsetof(InputKeySelector_SetAllowMouseKeys, bInAllowMouseKeys) == 0x000000, "Member 'InputKeySelector_SetAllowMouseKeys::bInAllowMouseKeys' has a wrong offset!");
...
// Function UMG.InputKeySelector.SetRightClickToEmpty
// 0x0001 (0x0001 - 0x0000)
struct InputKeySelector_SetRightClickToEmpty final
{
public:
	bool                                          bInRightClickToEmpty;                              // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(InputKeySelector_SetRightClickToEmpty) == 0x000001, "Wrong alignment on InputKeySelector_SetRightClickToEmpty");
static_assert(sizeof(InputKeySelector_SetRightClickToEmpty) == 0x000001, "Wrong size on InputKeySelector_SetRightClickToEmpty");
static_assert(offsetof(InputKeySelector_SetRightClickToEmpty, bInRightClickToEmpty) == 0x000000, "Member 'InputKeySelector_SetRightClickToEmpty::bInRightClickToEmpty' has a wrong offset!");
