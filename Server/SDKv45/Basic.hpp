...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0561C740;
	constexpr int32 AppendString      = 0x00CAC670;
	constexpr int32 GNames            = 0x05613558;
	constexpr int32 GWorld            = 0x057048E8;
	constexpr int32 ProcessEvent      = 0x00EA1BD0;
