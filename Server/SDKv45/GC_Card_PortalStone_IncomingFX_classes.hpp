...
static_assert(sizeof(AGC_Card_PortalStone_IncomingFX_C) == 0x000850, "Wrong size on AGC_Card_PortalStone_IncomingFX_C");
static_assert(offsetof(AGC_Card_PortalStone_IncomingFX_C, UberGraphFrame) == 0x000840, "Member 'AGC_Card_PortalStone_IncomingFX_C::UberGraphFrame' has a wrong offset!");
