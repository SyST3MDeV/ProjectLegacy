...
#include "GC_Item_Buff_Major_AppliedLoop_classes.hpp"
#include "GC_Item_Buff_Major_AppliedLoop_parameters.hpp"
...
void AGC_Item_Buff_Major_AppliedLoop_C::ExecuteUbergraph_GC_Item_Buff_Major_AppliedLoop(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Buff_Major_AppliedLoop_C", "ExecuteUbergraph_GC_Item_Buff_Major_AppliedLoop");

	Params::GC_Item_Buff_Major_AppliedLoop_C_ExecuteUbergraph_GC_Item_Buff_Major_AppliedLoop Parms{};
...
void AGC_Item_Buff_Major_AppliedLoop_C::K2_WhileActive(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, class UParticleSystemComponent* LoopingParticleSystem, const TArray<class UParticleSystemComponent*>& AdditionalParticleSystem, class UNiagaraComponent* LoopingNiagaraParticleSystem, const TArray<class UNiagaraComponent*>& AdditionalNiagaraParticleSystems)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Buff_Major_AppliedLoop_C", "K2_WhileActive");

	Params::GC_Item_Buff_Major_AppliedLoop_C_K2_WhileActive Parms{};
...
// Function GC_Item_Buff_Major_AppliedLoop.GC_Item_Buff_Major_AppliedLoop_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void AGC_Item_Buff_Major_AppliedLoop_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GC_Item_Buff_Major_AppliedLoop_C", "UserConstructionScript");
