...
static_assert(sizeof(UMovieSceneSection) == 0x0000D0, "Wrong size on UMovieSceneSection");
...
static_assert(offsetof(UMovieSceneSection, PrerollTime) == 0x0000C8, "Member 'UMovieSceneSection::PrerollTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSection, PostrollTime) == 0x0000CC, "Member 'UMovieSceneSection::PostrollTime' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSegmentCompilerTestSection) == 0x0000D0, "Wrong size on UMovieSceneSegmentCompilerTestSection");
...
static_assert(sizeof(UMovieSceneSequence) == 0x000330, "Wrong size on UMovieSceneSequence");
...
static_assert(offsetof(UMovieSceneSequence, InstancedSubSequenceEvaluationTemplates) == 0x0002D8, "Member 'UMovieSceneSequence::InstancedSubSequenceEvaluationTemplates' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequence, bParentContextsAreSignificant) == 0x000328, "Member 'UMovieSceneSequence::bParentContextsAreSignificant' has a wrong offset!");
...
public:
	...
	EMovieScenePlayerStatus                       Status;                                            // 0x03A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3A1[0x3];                                      // 0x03A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bReversePlayback : 1;                              // 0x03A4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bPendingFirstUpdate : 1;                           // 0x03A4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_3A5[0xB];                                      // 0x03A5(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieSceneSequence*                    Sequence;                                          // 0x03B0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TimeCursorPosition;                                // 0x03B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         StartTime;                                         // 0x03BC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         EndTime;                                           // 0x03C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         CurrentNumLoops;                                   // 0x03C4(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3C8[0x10];                                     // 0x03C8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x03D8(0x0028)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_400[0x300];                                    // 0x0400(0x0300)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x000700, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, OnStop) == 0x000380, "Member 'UMovieSceneSequencePlayer::OnStop' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, OnPause) == 0x000390, "Member 'UMovieSceneSequencePlayer::OnPause' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Status) == 0x0003A0, "Member 'UMovieSceneSequencePlayer::Status' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, Sequence) == 0x0003B0, "Member 'UMovieSceneSequencePlayer::Sequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TimeCursorPosition) == 0x0003B8, "Member 'UMovieSceneSequencePlayer::TimeCursorPosition' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, StartTime) == 0x0003BC, "Member 'UMovieSceneSequencePlayer::StartTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, EndTime) == 0x0003C0, "Member 'UMovieSceneSequencePlayer::EndTime' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x0003C4, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x0003D8, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
