...
{
public:
	bool                                          bVirtualKeyboardSendsTextChanged;                  // 0x0028(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVirtualKeyboardDisplayOnFocus;                    // 0x0029(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bExplicitCanvasChildZOrder;                        // 0x002A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USlateSettings, bVirtualKeyboardSendsTextChanged) == 0x000028, "Member 'USlateSettings::bVirtualKeyboardSendsTextChanged' has a wrong offset!");
static_assert(offsetof(USlateSettings, bVirtualKeyboardDisplayOnFocus) == 0x000029, "Member 'USlateSettings::bVirtualKeyboardDisplayOnFocus' has a wrong offset!");
static_assert(offsetof(USlateSettings, bExplicitCanvasChildZOrder) == 0x00002A, "Member 'USlateSettings::bExplicitCanvasChildZOrder' has a wrong offset!");
