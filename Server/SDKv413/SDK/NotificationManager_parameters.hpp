...
{
public:
	struct FOrionNotification                     Notification_Data;                                 // 0x0000(0x01A0)(Parm)
	class UNotification_C*                        New_Notification;                                  // 0x01A0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UNotification_C*                        CallFunc_Create_ReturnValue;                       // 0x01B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(NotificationManager_C_Construct_New_Notification) == 0x0001C0, "Wrong size on NotificationManager_C_Construct_New_Notification");
...
static_assert(offsetof(NotificationManager_C_Construct_New_Notification, New_Notification) == 0x0001A0, "Member 'NotificationManager_C_Construct_New_Notification::New_Notification' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Construct_New_Notification, CallFunc_GetOwningPlayer_ReturnValue) == 0x0001A8, "Member 'NotificationManager_C_Construct_New_Notification::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Construct_New_Notification, CallFunc_Create_ReturnValue) == 0x0001B0, "Member 'NotificationManager_C_Construct_New_Notification::CallFunc_Create_ReturnValue' has a wrong offset!");
...
public:
	...
	class UNotification_C*                        Old_Notification;                                  // 0x01A0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UNotification_C* Widget)> K2Node_CreateDelegate_OutputDelegate;             // 0x01A8(0x0010)(ZeroConstructor, NoDestructor)
	class UUserWidget*                            CallFunc_FindUserWidget_ReturnValue;               // 0x01B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x01C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1C1[0x7];                                      // 0x01C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UNotification_C*                        K2Node_DynamicCast_AsNotification;                 // 0x01C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(NotificationManager_C_Remove_Dead_Notification) == 0x0001E0, "Wrong size on NotificationManager_C_Remove_Dead_Notification");
...
static_assert(offsetof(NotificationManager_C_Remove_Dead_Notification, Old_Notification) == 0x0001A0, "Member 'NotificationManager_C_Remove_Dead_Notification::Old_Notification' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Remove_Dead_Notification, K2Node_CreateDelegate_OutputDelegate) == 0x0001A8, "Member 'NotificationManager_C_Remove_Dead_Notification::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Remove_Dead_Notification, CallFunc_FindUserWidget_ReturnValue) == 0x0001B8, "Member 'NotificationManager_C_Remove_Dead_Notification::CallFunc_FindUserWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Remove_Dead_Notification, CallFunc_IsValid_ReturnValue) == 0x0001C0, "Member 'NotificationManager_C_Remove_Dead_Notification::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Remove_Dead_Notification, K2Node_DynamicCast_AsNotification) == 0x0001C8, "Member 'NotificationManager_C_Remove_Dead_Notification::K2Node_DynamicCast_AsNotification' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Remove_Dead_Notification, K2Node_DynamicCast_bSuccess) == 0x0001D0, "Member 'NotificationManager_C_Remove_Dead_Notification::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
{
public:
	class UNotification_C*                        Widget;                                            // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	TDelegate<void(const struct FOrionNotification& Notification)> K2Node_CreateDelegate_OutputDelegate; // 0x0018(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(NotificationManager_C_Set_Display_State) == 0x000030, "Wrong size on NotificationManager_C_Set_Display_State");
...
static_assert(offsetof(NotificationManager_C_Set_Display_State, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'NotificationManager_C_Set_Display_State::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Set_Display_State, CallFunc_NotEqual_BoolBool_ReturnValue) == 0x000010, "Member 'NotificationManager_C_Set_Display_State::CallFunc_NotEqual_BoolBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Set_Display_State, CallFunc_IsValid_ReturnValue) == 0x000011, "Member 'NotificationManager_C_Set_Display_State::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(NotificationManager_C_Set_Display_State, K2Node_CreateDelegate_OutputDelegate) == 0x000018, "Member 'NotificationManager_C_Set_Display_State::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
