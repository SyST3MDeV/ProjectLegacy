...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05A9FEC0;
	constexpr int32 AppendString      = 0x01019F20;
	constexpr int32 GNames            = 0x05A97180;
	constexpr int32 GWorld            = 0x05BAFB88;
	constexpr int32 ProcessEvent      = 0x011F8160;
