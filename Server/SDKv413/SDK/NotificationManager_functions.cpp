...
// Parameters:
// const struct FOrionNotification&        Notification_Data                                      (Parm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FOrionNotification&        Notification                                           (Parm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UNotification_C*                  Widget                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
