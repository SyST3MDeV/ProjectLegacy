...
static_assert(sizeof(AQosBeaconClient) == 0x000480, "Wrong size on AQosBeaconClient");
...
static_assert(sizeof(UQosRegionManager) == 0x0000A0, "Wrong size on UQosRegionManager");
...
static_assert(offsetof(UQosRegionManager, SelectedRegionId) == 0x000080, "Member 'UQosRegionManager::SelectedRegionId' has a wrong offset!");
