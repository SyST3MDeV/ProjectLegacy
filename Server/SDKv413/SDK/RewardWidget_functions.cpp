...
// (Event, Public, BlueprintEvent)
// Parameters:
// int32                                   RoundsRemaining                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// EOrionRewardWidgetState                 State                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void URewardWidget_C::OnDataSet(EOrionItemRarity ItemRarity)
{
	static class UFunction* Func = nullptr;
...
void URewardWidget_C::Fanfare_To_Complete()
{
	static class UFunction* Func = nullptr;
