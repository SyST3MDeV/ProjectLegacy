...
namespace CG
{
	 ...
	 * Parameters:
	 * 		EK2Node_SwitchEnum_CmpSuccess                      Position                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	 */
	void UCalloutMenu_C::SetPipPosition(EK2Node_SwitchEnum_CmpSuccess Position)
	{
