...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00EEF450
	 * 		Name   -> Function TeamCommsMenu-V3.TeamCommsMenu-V3_C.On Toggle Emotes
	 * 		Flags  -> (BlueprintCallable, BlueprintEvent)
	 */
	void UTeamCommsMenuV3_C::OnToggleEmotes()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TeamCommsMenu-V3.TeamCommsMenu-V3_C.On Toggle Emotes");
		
		UTeamCommsMenuV3_C_OnToggleEmotes_Params params {};
